...
<script setup>
    ...
    async function generateInsights(segment) {
        ...
        const endpoint = `https://hackathon-sm-standard-segments-838902823068.europe-west1.run.app/api/v1/segments/insights/${segment.segmentId}`;
    ...
    async function saveSegment() {
        ...
        try {
            const res = await fetch('https://hackathon-sm-standard-segments-838902823068.europe-west1.run.app/api/v1/segments', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'x-tenant': props.tenantId,
